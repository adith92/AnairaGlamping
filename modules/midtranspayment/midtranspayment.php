...
class MidtransPayment extends PaymentModule
{
    ...
    public function getContent()
    {
        if (Tools::isSubmit('submitMidtransPayment')) {
            Configuration::updateValue('MIDTRANS_ENABLED', (int)Tools::getValue('MIDTRANS_ENABLED'));
    ...
    protected function renderForm()
    {
        ...
        $helper->fields_value = array(
            'MIDTRANS_ENABLED' => (int)Configuration::get('MIDTRANS_ENABLED', 1),
        ...
        $helper->fields_form = array(array('form' => array('legend' => array('title' => $this->l('Midtrans Config')), 'input' => array(
            array('type'=>'switch','label'=>$this->l('Enable Midtrans'),'name'=>'MIDTRANS_ENABLED','is_bool'=>true,'values'=>array(array('id'=>'on','value'=>1,'label'=>$this->l('Enabled')),array('id'=>'off','value'=>0,'label'=>$this->l('Disabled')))),
            ...
            array('type' => 'password', 'label' => $this->l('Server Key'), 'name' => 'MIDTRANS_SERVER_KEY', 'required' => true),
            array('type' => 'password', 'label' => $this->l('Client Key'), 'name' => 'MIDTRANS_CLIENT_KEY', 'required' => true),
    ...
    {
        if (!$this->active || !(int)Configuration::get('MIDTRANS_ENABLED', 1)) { return; }
